...
## Security ⚠️
Fremote makes no attempts to secure ports that it opens or encrypt data that is sent through those ports. The application is for education purposes only and intended to be used on a trusted WiFi network and should not be used in public.
